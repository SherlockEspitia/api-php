...
class pacientes extends connection{
    ...
    public function post($json){
        ...
        if(!isset($datos['token'])){
            ...
            if($arrayToken){
                ...
                return $_respuestas->error_401("Token enviado es invalido o ha caducado");
            }
        }
    }
    ...
    private function modificarPaciente(){
        ...
        FechaNacimiento='$this->fechaNacimiento', Correo='$this->correo' WHERE PacienteId = '$this->pacienteid'";
